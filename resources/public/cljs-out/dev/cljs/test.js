...
var G__11512 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11512,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11512;
}
}));
...
var len__4736__auto___11517 = arguments.length;
var i__4737__auto___11518 = (0);
while(true){
if((i__4737__auto___11518 < len__4736__auto___11517)){
args__4742__auto__.push((arguments[i__4737__auto___11518]));

var G__11519 = (i__4737__auto___11518 + (1));
i__4737__auto___11518 = G__11519;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11514){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11515,G__11516,seq11514__$2);
}));
...
var file = cljs.core.get.call(null,map__11521__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11521__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11521__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__11520_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11520_SHARP_));
...
var temp__5720__auto___11523 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11523)){
var message_11524 = temp__5720__auto___11523;
cljs.core.println.call(null,message_11524);
} else {
}
...
var temp__5720__auto___11525 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11525)){
var message_11526 = temp__5720__auto___11525;
cljs.core.println.call(null,message_11526);
} else {
}
...
var output_dir__$1 = (function (){var G__11527 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__11527,"/"].join('');
} else {
return G__11527;
}
})();
...
var temp__5718__auto__ = ((typeof exception.stack === 'string')?(function (){var G__11529 = exception.stack;
var G__11529__$1 = (((G__11529 == null))?null:clojure.string.split_lines.call(null,G__11529));
var G__11529__$2 = (((G__11529__$1 == null))?null:cljs.core.get.call(null,G__11529__$1,depth));
if((G__11529__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11529__$2);
}
})():false);
if(cljs.core.truth_(temp__5718__auto__)){
var stack_element = temp__5718__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__11530 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11530,(0),null);
var column = cljs.core.nth.call(null,vec__11530,(1),null);
var vec__11533 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11533,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11533,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11533,(2),null);
...
var m__$1 = (function (){var G__11536 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__11540 = (function (){var G__11539 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11539);
} else {
return G__11539;
}
})();
...
return cljs.core.vary_meta.call(null,G__11541,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__11545 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11545,(0),null);
var types = vec__11545;
...
return cljs.core.map.call(null,(function (p__11548){
var vec__11549 = p__11548;
var ns = cljs.core.nth.call(null,vec__11549,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11549,(1),null);
return (function (){
...
var G__11552 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__11552__$1 = (((G__11552 instanceof cljs.core.Keyword))?G__11552.fqn:null);
switch (G__11552__$1) {
case "async":
...
var seq__11553 = cljs.core.seq.call(null,vars__$1);
var chunk__11554 = null;
var count__11555 = (0);
var i__11556 = (0);
while(true){
if((i__11556 < count__11555)){
var v = cljs.core._nth.call(null,chunk__11554,i__11556);
var temp__5720__auto___11558 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11558)){
var t_11559 = temp__5720__auto___11558;
each_fixture_fn.call(null,((function (seq__11553,chunk__11554,count__11555,i__11556,t_11559,temp__5720__auto___11558,v,each_fixture_fn,G__11552,G__11552__$1,env,once_fixtures,each_fixtures,vec__11549,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11559)));
});})(seq__11553,chunk__11554,count__11555,i__11556,t_11559,temp__5720__auto___11558,v,each_fixture_fn,G__11552,G__11552__$1,env,once_fixtures,each_fixtures,vec__11549,ns,vars__$1))
);
} else {
}


var G__11560 = seq__11553;
var G__11561 = chunk__11554;
var G__11562 = count__11555;
var G__11563 = (i__11556 + (1));
seq__11553 = G__11560;
chunk__11554 = G__11561;
count__11555 = G__11562;
i__11556 = G__11563;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__11553);
if(temp__5720__auto__){
var seq__11553__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__11553__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__11553__$1);
var G__11564 = cljs.core.chunk_rest.call(null,seq__11553__$1);
var G__11565 = c__4556__auto__;
var G__11566 = cljs.core.count.call(null,c__4556__auto__);
var G__11567 = (0);
seq__11553 = G__11564;
chunk__11554 = G__11565;
count__11555 = G__11566;
i__11556 = G__11567;
continue;
} else {
var v = cljs.core.first.call(null,seq__11553__$1);
var temp__5720__auto___11568__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11568__$1)){
var t_11569 = temp__5720__auto___11568__$1;
each_fixture_fn.call(null,((function (seq__11553,chunk__11554,count__11555,i__11556,t_11569,temp__5720__auto___11568__$1,v,seq__11553__$1,temp__5720__auto__,each_fixture_fn,G__11552,G__11552__$1,env,once_fixtures,each_fixtures,vec__11549,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11569)));
});})(seq__11553,chunk__11554,count__11555,i__11556,t_11569,temp__5720__auto___11568__$1,v,seq__11553__$1,temp__5720__auto__,each_fixture_fn,G__11552,G__11552__$1,env,once_fixtures,each_fixtures,vec__11549,ns,vars__$1))
);
} else {
}


var G__11570 = cljs.core.next.call(null,seq__11553__$1);
var G__11571 = null;
var G__11572 = (0);
var G__11573 = (0);
seq__11553 = G__11570;
chunk__11554 = G__11571;
count__11555 = G__11572;
i__11556 = G__11573;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11552__$1)].join('')));
