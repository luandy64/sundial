...
var o11568 = temp__5718__auto__;
var temp__5718__auto____$1 = (o11568["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o11569 = temp__5718__auto____$1;
return (o11569["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__10677__auto__ = f;
return (o__10677__auto__["toString"]).call(o__10677__auto__);
} else {
return "";
}
}catch (e11570){var _ = e11570;
return "";
}});
...
try{var o__10677__auto___11572 = t;
(o__10677__auto___11572["cljs$lang$ctorPrWriter"]).call(o__10677__auto___11572,t,writer);
}catch (e11571){var __11573 = e11571;
}
...
var char_code = (function (){var o__10677__auto__ = (new String(char$));
return (o__10677__auto__["charCodeAt"]).call(o__10677__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__10677__auto__ = String;
return (o__10677__auto__["fromCharCode"]).call(o__10677__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__11574 = num_code;
switch (G__11574) {
case (1):
return (185);
...
var o__10677__auto__ = String;
return (o__10677__auto__["fromCharCode"]).call(o__10677__auto__,superscript_code);
});
/**
...
}catch (e11576){var _e__10684__auto__ = e11576;
return false;
}})())){
...
var vec__11577 = devtools.munging.parse_fn_source.call(null,fn_source);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o11580 = temp__5718__auto__;
var temp__5718__auto____$1 = (o11580["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o11581 = temp__5718__auto____$1;
return (o11581["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___11588 = arguments.length;
var i__4737__auto___11589 = (0);
while(true){
if((i__4737__auto___11589 < len__4736__auto___11588)){
args__4742__auto__.push((arguments[i__4737__auto___11589]));

var G__11590 = (i__4737__auto___11589 + (1));
i__4737__auto___11589 = G__11590;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__11584){
var vec__11585 = p__11584;
var ns_detector = cljs.core.nth.call(null,vec__11585,(0),null);
...
var G__11591 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__11592 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__11591;
remaining_tokens = G__11592;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq11582){
var G__11583 = cljs.core.first.call(null,seq11582);
var seq11582__$1 = cljs.core.next.call(null,seq11582);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11583,seq11582__$1);
}));
...
var vec__11596 = cljs.core.split_with.call(null,(function (p1__11595_SHARP_){
return cljs.core.not_EQ_.call(null,p1__11595_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__11596,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__11596,(1),null);
...
var vec__11602 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__11602,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__11602,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__11605 = cljs.core.rest.call(null,remaining_tokens);
var G__11606 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__11605;
name_tokens = G__11606;
continue;
} else {
...
var vec__11609 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__11609,(0),null);
var arity = cljs.core.nth.call(null,vec__11609,(1),null);
var vec__11612 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__11612,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__11612,(1),null);
var vec__11615 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__11615,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__11615,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__11615,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__11615,(3),null);
...
var vec__11621 = result;
var munged_ns = cljs.core.nth.call(null,vec__11621,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__11621,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__11621,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__11621,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__11621,(4),null);
var arity = cljs.core.nth.call(null,vec__11621,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__11625 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__11625,(0),null);
var args = cljs.core.nth.call(null,vec__11625,(1),null);
var vec__11628 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__11628,(0),null);
var name = cljs.core.nth.call(null,vec__11628,(1),null);
...
var G__11631 = (arity + (1));
var G__11632 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__11633){
var vec__11634 = p__11633;
var arity = cljs.core.nth.call(null,vec__11634,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__11634,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__11637_SHARP_){
return cljs.core.get.call(null,arities,p1__11637_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__11638_SHARP_){
return cljs.core.drop.call(null,(2),p1__11638_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___11645 = arguments.length;
var i__4737__auto___11646 = (0);
while(true){
if((i__4737__auto___11646 < len__4736__auto___11645)){
args__4742__auto__.push((arguments[i__4737__auto___11646]));

var G__11647 = (i__4737__auto___11646 + (1));
i__4737__auto___11646 = G__11647;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__11641){
var vec__11642 = p__11641;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__11642,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq11639){
var G__11640 = cljs.core.first.call(null,seq11639);
var seq11639__$1 = cljs.core.next.call(null,seq11639);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11640,seq11639__$1);
}));
...
var G__11648 = arg;
var G__11648__$1 = (((G__11648 instanceof cljs.core.Keyword))?G__11648.fqn:null);
switch (G__11648__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__11650__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__11650__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__11650__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__11650__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__11651 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__11651,(0),null);
var fn_name = cljs.core.nth.call(null,vec__11651,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__11651,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__11651,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__11651,(4),null);
var arity = cljs.core.nth.call(null,vec__11651,(5),null);
...
var o__10677__auto__ = f;
return (o__10677__auto__["getBasis"]).call(o__10677__auto__);
});
/**
...
}catch (e11655){var _e__10684__auto__ = e11655;
...
var G__11656 = (obj[cljs.core.first.call(null,path)]);
var G__11657 = cljs.core.rest.call(null,path);
obj = G__11656;
path = G__11657;
continue;
} else {
...
var _STAR_ = (function (accum,p__11658){
var vec__11659 = p__11658;
var bit = cljs.core.nth.call(null,vec__11659,(0),null);
var protocol = cljs.core.nth.call(null,vec__11659,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__11662){
var vec__11663 = p__11662;
var ns = cljs.core.nth.call(null,vec__11663,(0),null);
var name = cljs.core.nth.call(null,vec__11663,(1),null);
var selector = cljs.core.nth.call(null,vec__11663,(2),null);
...
var post_process = (function (p__11667){
var vec__11668 = p__11667;
var munged_name = cljs.core.nth.call(null,vec__11668,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__11668,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__11666_SHARP_){
return (obj[cljs.core.first.call(null,p1__11666_SHARP_)]);
}),sorted_matches);
