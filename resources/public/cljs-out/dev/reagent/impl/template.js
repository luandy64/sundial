...
var G__11729 = o;
goog.object.set(G__11729,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__11731__i < G__11731__a.length) {G__11731__a[G__11731__i] = arguments[G__11731__i + 0]; ++G__11731__i;}
  args = new cljs.core.IndexedSeq(G__11731__a,0,null);
} 
...
var G__11733 = o;
goog.object.set(G__11733,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__11734__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__11735__i < G__11735__a.length) {G__11735__a[G__11735__i] = arguments[G__11735__i + 0]; ++G__11735__i;}
  args = new cljs.core.IndexedSeq(G__11735__a,0,null);
} 
return G__11734__delegate.call(this,args);};
G__11734.cljs$lang$maxFixedArity = 0;
G__11734.cljs$lang$applyTo = (function (arglist__11736){
var args = cljs.core.seq(arglist__11736);
return G__11734__delegate(args);
});
...
var G__11737 = props;
var G__11737__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11737,cljs.core.cst$kw$id,id):G__11737);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11737__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__11737__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__11738 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11738,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__11738;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__11739){
var map__11740 = p__11739;
var map__11740__$1 = (((((!((map__11740 == null))))?(((((map__11740.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11740.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__11740):map__11740);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11740__$1,cljs.core.cst$kw$on_DASH_write);
...
return (jsprops.onChange = (function (p1__11742_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__11742_SHARP_);
}));
} else {
return null;
}
...
var vec__11745 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11745,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11745,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11745,(2),null);
...
var temp__5724__auto___11749 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___11749 == null)){
} else {
var key_11750 = temp__5724__auto___11749;
(jsprops.key = key_11750);
}
...
var temp__5724__auto___11751 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___11751 == null)){
} else {
var key_11752 = temp__5724__auto___11751;
(jsprops.key = key_11752);
}
...
var G__11753 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__11753) : reagent.impl.template.as_element.call(null,G__11753));
} else {
var temp__5724__auto___11754 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5724__auto___11754 == null)){
} else {
var key_11755 = temp__5724__auto___11754;
(jsprops.key = key_11755);
}
...
var G__11757 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__11757)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__11757)){
return x;
} else {
...
var len__4736__auto___11760 = arguments.length;
var i__4737__auto___11761 = (0);
while(true){
if((i__4737__auto___11761 < len__4736__auto___11760)){
args__4742__auto__.push((arguments[i__4737__auto___11761]));

var G__11762 = (i__4737__auto___11761 + (1));
i__4737__auto___11761 = G__11762;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq11758){
var G__11759 = cljs.core.first(seq11758);
var seq11758__$1 = cljs.core.next(seq11758);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11759,seq11758__$1);
}));
...
break;
default:
var G__11765 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__11765;
continue;
...
var ctx = ({});
var vec__11767 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11767,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11767,(1),null);
...
var G__11770 = (cljs.core.count(argv) - first_child);
switch (G__11770) {
case (0):
...
break;
case (1):
var G__11771 = component;
var G__11772 = jsprops;
var G__11773 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__11771,G__11772,G__11773);
